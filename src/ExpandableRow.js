...
class ExpandableRow extends React.Component {
  ...
  renderExpandIcon = () => {
    const { prefixCls, expanded, record, needIndentSpaced, expandIconRender } = this.props;

    if (expandIconRender) {
      return expandIconRender({prefixCls, expanded, record, needIndentSpaced, expandable: this.expandable, onExpand: this.handleExpandChange});
    }
